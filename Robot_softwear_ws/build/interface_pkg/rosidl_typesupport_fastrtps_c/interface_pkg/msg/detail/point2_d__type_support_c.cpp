...
#include "interface_pkg/msg/detail/point2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Point2D__ros_msg_type = interface_pkg__msg__Point2D;
...
size_t get_serialized_size_interface_pkg__msg__Point2D(
  const void * untyped_ros_message,
...
static uint32_t _Point2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_pkg__msg__Point2D(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface_pkg
size_t max_serialized_size_interface_pkg__msg__Point2D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Point2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_pkg__msg__Point2D(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_pkg, msg, Point2D)() {
